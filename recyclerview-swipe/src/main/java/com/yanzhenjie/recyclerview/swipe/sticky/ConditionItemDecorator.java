package com.yanzhenjie.recyclerview.swipe.sticky;
 ...
 * To determine which item should decorate you can use {@link Condition}
...
public class ConditionItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public interface Decor {
         ...
         * Called once before {@link Decor#onDrawOver(Canvas, RecyclerView, View, int, RecyclerView.State)}
         *
        ...
        /**
         * Called every time when called {@link RecyclerView.ItemDecoration#onDrawOver(Canvas, RecyclerView, RecyclerView.State)}.
         * Called once after {@link Decor#onDrawOver(Canvas, RecyclerView, View, int, RecyclerView.State)}
         *
         * @param c      Canvas to draw into
         * @param parent RecyclerView this Decor is drawing into
         * @param state  The current state for RecyclerView
        ...
        /**
         * Retrieve any offsets for the given item which satisfies condition {@link Condition#isForDrawOver(int)}.
